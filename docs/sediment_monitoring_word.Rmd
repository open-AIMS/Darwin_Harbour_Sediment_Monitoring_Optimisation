...
interpolation is driven mostly by the value of promimal observations
...
unweighted versions will be presented in Appendix ?
...
Figure \@ref(fig:coplotINNORMALISED60wtd) directly compares the
spatial interpolations for the full versus optimised to 60 free sites
configuration (weighted by distance from urbanisation).
...
Figure \@ref(fig:coplotOHNORMALISED60wtd) directly compares the
spatial interpolations for the full versus optimised to 60 free sites
configuration (weighted by distance from urbanisation).
