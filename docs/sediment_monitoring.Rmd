...
This interactive, self-contained html constitutes a supplimentary to a
report (Logan, M (2022). Darwin Harbour Sediment Monitoring Design
Optimisation. Report prepared for Northern Territory Government,
Department of Environment, Parks and Water Security. Australian
Institute of Marine Science, Location.  (32 pp)) commissioned by the
Northern Territory Government and authored by AIMS.  The information
contained herein is largely duplicated from that report
...
```{r dataSourceTable, eval=TRUE, echo=FALSE, tab.topcaption=TRUE, tab.cap.style = "Table Caption", tab.id='dataSource', label = 'dataSource', tab.cap = 'Metadata of data sources provided by DEPW.', results='asis'}
df <- tribble(
